...
namespace sirius
{
	...
	public:
		typedef struct _err_code_t
		{
			...
			static const int32_t slot_count_danger = 1403;
			static const int32_t gpu_load_danger = 1404;
			static const int32_t gpu_error_detection = 1405;
			static const int32_t invalid_file_path = 1406;
