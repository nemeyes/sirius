...
IF /i %build_mode%=="debug" xcopy /Y %work_dir%\platform\win32\v140\x86\%build_mode%\bin\sirius_png_compressor.pdb				%work_dir%\platform\win32\v140\x86\%build_mode%\bin\apps\attendants\web\
...
IF /i %build_mode%=="debug" xcopy /Y %work_dir%\platform\win32\v140\x86\%build_mode%\bin\sirius_partial_png_compressor.pdb			%work_dir%\platform\win32\v140\x86\%build_mode%\bin\apps\attendants\web\
...
IF /i %build_mode%=="debug" xcopy /Y %work_dir%\platform\win32\v140\x86\%build_mode%\bin\sirius_internal_notifier.pdb				%work_dir%\platform\win32\v140\x86\%build_mode%\bin\apps\attendants\web\
