#include <winsock2.h>
#include <windows.h>
#include "arodnap_control_client.h"


arodnap_control_client::arodnap_control_client(int recv_buffer_size)
	: base_client(recv_buffer_size)
{

}

arodnap_control_client::~arodnap_control_client(void)
{

}

void arodnap_control_client::on_connect_to_server(void)
{
	int packet_size = 0;
...
void arodnap_control_client::on_disconnect_from_server(void)
{

}

void arodnap_control_client::on_connect(void)
{
	int packet_size = 0;
...
void arodnap_control_client::on_recv(const char * packet, int packet_size)
{
...
*/
const char * arodnap_control_client::make_connect_req_packet(int & packet_size)
{
...
*/
const char * arodnap_control_client::make_stbinfo_packet(int & packet_size)
{
	int command = 3010;
