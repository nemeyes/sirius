...
client_controller::client_controller(CSiriusClientDlg * front, bool keepalive, int32_t keepalive_timeout, bool tls)
	: _front(front)
	, _hmodule(NULL)
	, _framework(NULL)
{
	...
	_controller = new sirius::app::client::proxy(this, keepalive, keepalive_timeout, tls, inst, hwnd);
}
