...
sirius::library::net::iocp::client::client(sirius::library::net::client * processor, int32_t mtu, int32_t so_rcvbuf_size, int32_t so_sndbuf_size, int32_t recv_buffer_size,bool dynamic_alloc)
...
/*
std::shared_ptr<sirius::library::net::session> sirius::library::net::iocp_client::connect(const char * address, int32_t port_number, int32_t io_thread_pool_count)
{
...
bool sirius::library::net::iocp::client::disconnect(void)
{
...
void sirius::library::net::iocp::client::close(std::shared_ptr<sirius::library::net::session> session)
{
...
bool sirius::library::net::iocp::client::recv_completion_callback(std::shared_ptr<sirius::library::net::session> session, std::shared_ptr<sirius::library::net::session::recv_buffer_t> context, int32_t nbytes)
{
...
bool sirius::library::net::iocp::client::send_completion_callback(std::shared_ptr<sirius::library::net::session> session, std::shared_ptr<sirius::library::net::session::send_buffer_t> context, int32_t nbytes)
{
	session->pop_send_buffer(context);
	return true;
}

bool sirius::library::net::iocp::client::other_completion_callback(std::shared_ptr<sirius::library::net::session> session, int32_t nbytes)
{
...
bool sirius::library::net::iocp::client::post_recv(std::shared_ptr<sirius::library::net::session> session, int32_t size)
{
	DWORD nbytes = 0;
	DWORD flags = 0;
...
bool sirius::library::net::iocp::client::post_send(std::shared_ptr<sirius::library::net::session> session, std::vector<std::shared_ptr<sirius::library::net::session::send_buffer_t>> sendQ)
{
	DWORD nbytes = 0;
	DWORD flags = 0;
...
std::shared_ptr<sirius::library::net::session> sirius::library::net::iocp::client::allocate_session(SOCKET client_socket)
{
...
//
//void sirius::library::net::iocp_client::execute(void)
//{
//	sirius::library::net::session * session = NULL;
//	sirius::library::net::io_context_t * io_context = NULL;
//	DWORD nbytes = 0;
//	int32_t err_code = 0;
//
//	while (1)
...
//
//			// IO 성격에 따라 그에 따른 처리
//			if (io_context->operation == sirius::library::net::io_context_t::operation_t::recv)
//			{
...
//				}
//			}
//			else if (io_context->operation == sirius::library::net::io_context_t::operation_t::send)
//			{
