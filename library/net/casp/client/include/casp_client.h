#ifndef _CASP_CLIENT_H_
#define _CASP_CLIENT_H_
	...
	namespace library
	{
		namespace net
		{
			namespace casp
			{
				...
				public:
					core(sirius::library::net::casp::client * front);
					virtual ~core(void);
					...
					void push_video_packet(sirius::library::net::casp::cmd_stream_data_t * packet, uint8_t * data, int32_t length);

				private:
					sirius::library::net::casp::client * _front;
