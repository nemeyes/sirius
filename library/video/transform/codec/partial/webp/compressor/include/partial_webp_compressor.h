#ifndef _PARTIAL_WEBP_COMPRESSOR_H_
#define _PARTIAL_WEBP_COMPRESSOR_H_
					...
					namespace partial
					{
						namespace webp
						{
							...
							public:
								...
								static const int32_t MAX_WEBP_SIZE = 1024 * 1024 * 1;
								...
								typedef struct _indexed_thread_context_t
								{
									...
									sirius::library::video::transform::codec::partial::webp::compressor::entity_t	output;
									sirius::library::video::transform::codec::libwebp::compressor *					real_compressor;
									sirius::library::video::transform::codec::partial::webp::compressor::core *		parent;
								...
								{
									sirius::library::video::transform::codec::partial::webp::compressor::core::ibuffer_t	input;
								} buffer_t;

							public:
								core(sirius::library::video::transform::codec::partial::webp::compressor * front);
								~core(void);
								...
								int32_t compress(sirius::library::video::transform::codec::partial::webp::compressor::entity_t * input);

							private:
								static unsigned __stdcall process_callback(void * param);
								static unsigned __stdcall process_threaded_indexed_encoding_callback(void * param);
								static unsigned __stdcall process_threaded_coordinated_encoding_callback(void * param);
								...
								void	copy(sirius::library::video::transform::codec::partial::webp::compressor::entity_t * input, sirius::library::video::transform::codec::partial::webp::compressor::core::buffer_t * iobuffer);
							...
							private:
								...
								sirius::library::video::transform::codec::partial::webp::compressor::core::buffer_t										_iobuffer[MAX_IO_BUFFERS];
								sirius::queue<sirius::library::video::transform::codec::partial::webp::compressor::core::buffer_t>						_iobuffer_queue;
								sirius::library::video::transform::codec::libwebp::compressor *															_real_compressor;
								std::map<int32_t, sirius::library::video::transform::codec::partial::webp::compressor::core::compressed_cache_image_t*>	_indexed_cache_image;
