#ifndef _PNGQUANT_COMPRESSOR_H_
#define _PNGQUANT_COMPRESSOR_H_
				...
				namespace codec
				{
					namespace png
					{
						...
						public:
							...
							{
								sirius::library::video::transform::codec::png::compressor::core::ibuffer_t	input;
								sirius::library::video::transform::codec::png::compressor::core::obuffer_t	output;
							} buffer_t;


							typedef struct _png_write_state_t
							{
								sirius::library::video::transform::codec::png::compressor::core::obuffer_t * compressed;
						...
						public:
							core(sirius::library::video::transform::codec::png::compressor * front);
							~core(void);

							int32_t state(void);

							int32_t initialize(sirius::library::video::transform::codec::png::compressor::context_t * context);
						...
						private:
							...
							sirius::library::video::transform::codec::png::compressor::core::buffer_t _iobuffer[MAX_IO_BUFFERS];
